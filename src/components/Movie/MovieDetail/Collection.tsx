...
const Collection = ({ movie, show }: { movie: MovieProps; show: Boolean }) => {
  ...
  const posterUrl = collection?.backdrop_path
    ? `https://image.tmdb.org/t/p/w1280${collection.backdrop_path}`
    : "https://placehold.co/250x400/000000/000000f1?text=N/A";

  return (
    <>
      {collection && (
        <section
          className="px-5 h-full 1lg:px-10  2xl:px-0 relative Collections bg-cover bg-fixed bg-center"
